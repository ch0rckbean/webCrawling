...
# topicTitles2=list(set(topicTitles2)) #순서 유지 x: 토픽 제목 순서가 섞이기 때문에
topicTitles2=list(OrderedDict.fromkeys(topicTitles2)) #topic 순서를 유지하기 위해 OrderedDict 사용
...
###토픽 업로드 날짜 크롤링: 토픽과 같이 같은 토픽의 날짜들이 중복되어 여러개 크롤링 되나, 토픽과 달리 중복을 걸러낼 수 없기에 제외하였음
# dateList=[]
